using IssuesProject;
using IssuesProject.Exceptions;
using System.Reflection;

namespace IssueProject.Test
{
    public class IssueTests
    {
        ...
        public void constructor_WithNotProvidingCreatedAt_ReturnsCreatedAtCurrentDateTime()
        {
            // Arrange


            var sut = new Issue("Hej ", Priority.Low, Category.Hardware);
        ...
        public void GenerateKey_WithIssueValidProperties_Return18CharIssueKey()
        {
            ...
            MethodInfo methodInfo = typeof(Issue).GetMethod("GenerateKey",
                BindingFlags.NonPublic | BindingFlags.Instance); // for tets the private Methode
        ...
        public void GenerateKey_WithIssueCreatedAt_ReturnIssueKeySecondSegmentYYYY()
        {
            // Arrange 
            var sut = new Issue("Issue #1", Priority.Low, Category.Hardware,
                new DateTime(2025, 10, 11, 12, 30, 00));
